this.mySupport = function () {
    ...
    */
    ...
    function disableRightClick(e) {
        var vType = new mySupport();
        var t = vType.mouseButton(e);
        if (t == "right") {
    ...
    function mouseButton(e) {
        ...
        if (typeof (e.which) == 'number') {
            switch (e.which) {
                case 1: vType = "left"; break;
                case 2: vType = "middle"; break;
                case 3: vType = "right"; break;
            }
        } else {
            switch (e.button) {
                case 1: vType = "left"; break;
                case 4: vType = "middle"; break;
                case 2: vType = "right"; break;
            }
        }
        return vType;
    }
